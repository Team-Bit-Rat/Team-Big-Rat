...
/// <summary>
/// IA 2D do Espirito Errante - sem NavMesh
/// Sprite nativo olha para a ESQUERDA
/// </summary>
[RequireComponent(typeof(Animator))]
[RequireComponent(typeof(Rigidbody2D))]
public class EspiritoErranteAI : MonoBehaviour
{
    [Header("Referências")]
    ...
    void AplicarDanoNoPlayer()
    {
        ...
        Debug.Log($"[Espirito Errante] Causou {danoAtaque} de dano!");
    }
